...
var possibleConstructorReturn = function(self, call2) {
  if (!self) {
    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  }
  return call2 && (typeof call2 === "object" || typeof call2 === "function") ? call2 : self;
};
...
function createStyledComponent(target, options, rules) {
  ...
  WrappedStyledComponent = import_react2.default.forwardRef(forwardRef3);
...
var possibleConstructorReturn2 = function(self, call2) {
  if (!self) {
    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  }
  return call2 && (typeof call2 === "object" || typeof call2 === "function") ? call2 : self;
...
var useLayoutEffect2 = typeof window !== "undefined" && window.document && window.document.createElement ? React6.useLayoutEffect : React6.useEffect;
...
var withAnimated = (Component2, host2) => {
  ...
  return (0, import_react6.forwardRef)((givenProps, givenRef) => {
    ...
    return React7.createElement(Component2, _extends4({}, usedProps, {
      ref
    }));
  });
};
...
function useTransition(data, props, deps) {
  ...
  const transitions = [];
  const usedTransitions = (0, import_react7.useRef)(null);
  ...
  const renderTransitions = (render) => React8.createElement(React8.Fragment, null, transitions.map((t, i) => {
    const {
      springs
    } = changes.get(t) || t.ctrl;
    const elem = render(_extends5({}, springs), t.item, t, i);
    return elem && elem.type ? React8.createElement(elem.type, _extends5({}, elem.props, {
...
***************************************************************************** */
//# sourceMappingURL=/build/_shared/chunk-BCGXVSLA.js.map
