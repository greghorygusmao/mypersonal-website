...
} from "/build/_shared/chunk-KH4E7I3U.js";
import {
  __esm,
  __toModule,
  init_react,
...
var init_routeMatching = __esm({
  "node_modules/@remix-run/react/esm/routeMatching.js"() {
    init_react();
    import_react_router_dom = __toModule(require_main2());
  }
});
...
var React3, import_react_router_dom2, RemixEntryContext, RemixRouteContext, Link, isHydrated, Form, FormImpl, nextNavigationSubmission;
var init_components = __esm({
  "node_modules/@remix-run/react/esm/components.js"() {
    init_react();
    init_rollupPluginBabelHelpers();
    React3 = __toModule(require_react());
    import_react_router_dom2 = __toModule(require_main2());
    ...
    Link = /* @__PURE__ */ React3.forwardRef(({
      to,
      prefetch = "none",
      ...props
    }, forwardedRef) => {
...
var React5, import_react_router_dom3, STORAGE_KEY, positions, hydrated;
var init_scroll_restoration = __esm({
  "node_modules/@remix-run/react/esm/scroll-restoration.js"() {
    init_react();
    React5 = __toModule(require_react());
    import_react_router_dom3 = __toModule(require_main2());
    init_components();
...
var init_esm = __esm({
  "node_modules/@remix-run/react/esm/index.js"() {
    init_react();
    init_browser();
    import_react_router_dom4 = __toModule(require_main2());
    init_components();
 ...
 * @license MIT
 */
//# sourceMappingURL=/build/_shared/chunk-VSGSUTFO.js.map
