...
function createStyledComponent(target, options, rules) {
  ...
  WrappedStyledComponent = import_react6.default.forwardRef(forwardRef3);
...
var styles_default = "/build/_assets/styles-ZC5AB3SZ.css";
...
var styles_default2 = "/build/_assets/styles-FVQJHAVN.css";
...
var useOnce = (effect) => (0, import_react12.useEffect)(effect, emptyDeps);
var emptyDeps = [];
function useForceUpdate() {
  const update3 = (0, import_react12.useState)()[1];
  const mounted = (0, import_react12.useState)(makeMountedRef)[0];
...
function useMemoOne(getResult, inputs) {
  const [initial] = (0, import_react12.useState)(() => ({
    inputs,
    result: getResult()
  }));
  const committed = (0, import_react12.useRef)();
...
var useLayoutEffect2 = typeof window !== "undefined" && window.document && window.document.createElement ? React9.useLayoutEffect : React9.useEffect;
...
var withAnimated = (Component2, host2) => {
  ...
  return (0, import_react13.forwardRef)((givenProps, givenRef) => {
    const instanceRef = (0, import_react13.useRef)(null);
    const ref = hasInstance && (0, import_react13.useCallback)((value) => {
    ...
    const observerRef = (0, import_react13.useRef)();
    useLayoutEffect2(() => {
    ...
    (0, import_react13.useEffect)(callback, []);
    useOnce(() => () => {
      const observer2 = observerRef.current;
      each(observer2.deps, (dep) => removeFluidObserver(dep, observer2));
    });
    const usedProps = host2.getComponentProps(props.getValue());
    return React10.createElement(Component2, _extends4({}, usedProps, {
      ref
    }));
  });
};
...
var SpringContext = (_ref) => {
  ...
  return React11.createElement(Provider, {
    value: props
  }, children);
};
...
function useSprings(length, props, deps) {
  ...
  if (propsFn && !deps)
    deps = [];
  const ref = (0, import_react14.useMemo)(() => propsFn || arguments.length == 3 ? SpringRef() : void 0, []);
  const layoutId = (0, import_react14.useRef)(0);
  const forceUpdate = useForceUpdate();
  ...
  const ctrls = (0, import_react14.useRef)([...state.ctrls]);
  const updates = [];
...
var Project = ({ active, changeOpen }) => {
  ...
  return /* @__PURE__ */ React.createElement(Box_default, {
    ...
    type: "span",
    title: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Placerat scelerisque mauris habitasse lacus, a dolor. Scelerisque eleifend feugiat venenatis massa ultricies malesuada vitae pellentesque."
  }), /* @__PURE__ */ React.createElement(Box_default, {
...
var Home = () => {
  ...
  }), /* @__PURE__ */ React.createElement(Project_default, {
    key: e?.id,
    changeOpen: () => {
      setOpen(e);
    },
...
***************************************************************************** */
//# sourceMappingURL=/build/routes/index-JVOOBUFI.js.map
