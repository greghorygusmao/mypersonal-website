...
var Modal = ({
  ...
  return transition((item, props) => item && /* @__PURE__ */ import_react4.default.createElement("div", {
    className: styles_default.modalctn,
    key
  }, /* @__PURE__ */ import_react4.default.createElement(animated.div, {
    onClick: requestClose,
    className: styles_default.offset,
    style: {
      ...opacity,
      ...styleBg
    }
  }), /* @__PURE__ */ import_react4.default.createElement(animated.div, {
    className: styles_default.ctn,
    color,
    style: {
      ...style2,
      ...props
    ...
    color,
    className: inline ? styles_default.modalcontent : ""
  }, children))));
};
...
var toLocaleDateStringFactory = function toLocaleDateStringFactory2(locale) {
  return function(date, dateTimeOptions2) {
    var key2 = date.toString();
    var lds = localeDateStringCache[key2];
    if (!lds) {
      lds = date.toLocaleDateString(locale, dateTimeOptions2);
      localeDateStringCache[key2] = lds;
    }
    return lds;
  };
};
...
//# sourceMappingURL=/build/routes/index-J5DV6DB5.js.map
