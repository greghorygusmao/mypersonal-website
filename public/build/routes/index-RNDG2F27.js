import {
  require_react_dom
} from "/build/_shared/chunk-L522XPW5.js";
import {
  SmoothScrollContext,
  clsx_m_default
...
var styles_default = "/build/_assets/styles-NIUHCSF7.css";
...
var Elements_default = "/build/_assets/Elements-QQTN3B7P.png";
...
var Layout = ({ mobile, children, scroll = false }) => {
  ...
  return /* @__PURE__ */ React.createElement(Box_default, {
    ...
    ref,
    style: {
      background: `url('${mobile ? Elements_default : Circle_default}')`,
...
function constructWithOptions(componentConstructor, tag) {
  ...
  templateFunction.withConfig = function(config2) {
    return constructWithOptions(componentConstructor, tag, _extends({}, options, config2));
  };
...
function createStyledComponent(target, options, rules) {
  ...
  WrappedStyledComponent = import_react7.default.forwardRef(forwardRef3);
...
function useForceUpdate() {
  const update3 = (0, import_react10.useState)()[1];
  const mounted = (0, import_react10.useState)(makeMountedRef)[0];
...
var useLayoutEffect2 = typeof window !== "undefined" && window.document && window.document.createElement ? React7.useLayoutEffect : React7.useEffect;
...
var withAnimated = (Component2, host2) => {
  ...
  return (0, import_react11.forwardRef)((givenProps, givenRef) => {
    ...
    return React8.createElement(Component2, _extends4({}, usedProps, {
      ref
    }));
  });
};
...
function useSprings(length, props, deps) {
  ...
  if (propsFn && !deps)
    deps = [];
  const ref = (0, import_react12.useMemo)(() => propsFn || arguments.length == 3 ? SpringRef() : void 0, []);
  const layoutId = (0, import_react12.useRef)(0);
  const forceUpdate = useForceUpdate();
  ...
  const ctrls = (0, import_react12.useRef)([...state.ctrls]);
  const updates = [];
  ...
  const context = (0, import_react12.useContext)(SpringContext);
  ...
  const values = springs.map((x) => _extends5({}, x));
...
function useTransition(data, props, deps) {
  ...
  const transitions = [];
  const usedTransitions = (0, import_react12.useRef)(null);
  ...
  const exitingTransitions = (0, import_react12.useRef)(new Map());
  const forceChange = (0, import_react12.useRef)(false);
  ...
  const renderTransitions = (render) => React9.createElement(React9.Fragment, null, transitions.map((t, i) => {
    const {
      springs
    } = changes.get(t) || t.ctrl;
    const elem = render(_extends5({}, springs), t.item, t, i);
    return elem && elem.type ? React9.createElement(elem.type, _extends5({}, elem.props, {
...
// app/assets/images/buscamilhas.png
var buscamilhas_default = "/build/_assets/buscamilhas-WUOT5C46.png";

// app/assets/images/dot8.png
var dot8_default = "/build/_assets/dot8-BBR2WGAH.png";

// app/assets/images/greg.png
var greg_default = "/build/_assets/greg-H337GHMP.png";

// app/assets/images/peixe.png
var peixe_default = "/build/_assets/peixe-OL5XNZEK.png";

// app/assets/images/seuingresso.png
var seuingresso_default = "/build/_assets/seuingresso-OTXX4ATH.png";

// app/assets/images/thaka.png
var thaka_default = "/build/_assets/thaka-GKO2GZZQ.png";
...
var BaseText = ({ title, children, style, className, onClick, type, aria, target, href }) => {
  ...
  return /* @__PURE__ */ import_react13.default.createElement(CustomTag, {
    className: `${className || ""}`,
    style,
    title: aria,
    ...hrefProp,
...
var styles_default3 = "/build/_assets/styles-7XXXKOD7.css";
...
var Footer = ({ relative }) => {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    href: "mailto:greghorygusmao@gmail.com"
  }, /* @__PURE__ */ React.createElement(BaseText_default, {
    className: "buttonlinksdefault_whatsapp",
    type: "span",
    title: "E-mail"
...
var styles_default4 = "/build/_assets/styles-MV62TLKX.css";
...
Project.links = links4;
var Project_default = Project;

// app/views/Home/styles.css
var styles_default5 = "/build/_assets/styles-JO2RNE5S.css";

// app/views/Home/Home.jsx
var links5 = [{ rel: "stylesheet", href: styles_default5 }, ...Project_default.links, ...Footer_default.links];
var PROJECTS = [
  {
    id: 0,
    name: "DOT|8",
    slogan: "Sistema de Controle e Gest\xE3o de Ponto",
    meta: "Remodelar a plataforma preexistente, construir a estrutura organizacional, recrutar e capacitar colaboradores, instaurar processos \xE1geis para aumentar a base de clientes, criar novos produtos.",
    result: "Lideramos e formamos um ordenamento estrat\xE9gico/criativo em todos os ambientes do neg\xF3cio. Sendo assim, atuamos diretamente na edifica\xE7\xE3o do ciclo de vida do produto, desde o entendimento de todas as interfaces do problema, a prepara\xE7\xE3o da equipe, at\xE9 o lan\xE7amento, monitoramento e medi\xE7\xE3o dos indicadores. Durante o processo, nos mantivemos alinhados aos interesses dos stakeholders, estabelecendo uma comunica\xE7\xE3o acess\xEDvel e coerente, a fim de permanecermos em conson\xE2ncia quanto \xE0s vis\xF5es estrat\xE9gicas e prioridades do projeto. Dentre os resultados alcan\xE7ados, em menos de um ano, constru\xEDmos um aplicativo robusto, com sistemas internos escal\xE1veis; obtivemos um crescimento financeiro de mais de 600% e estruturamos equipes coordenadas e autogerenciadas.",
  ...
  },
  {
    ...
    meta: "Organizar os setores operacionais, remodelar e criar novos features para o produto, aplicar metodologias \xE1geis e aumentar o faturamento.",
    result: "Reestruturamos a din\xE2mica operacional do produto e constru\xEDmos um Design System consistente por meio de metodologias \xE1geis que conectavam o backlog  \xE0 equipe de desenvolvimento. Por conseguinte, obtivemos como resultado uma plataforma com estrutura s\xF3lida, componentes autoajust\xE1veis e crescimento financeiro de mais de 50% em menos de 6 meses.",
  ...
  },
  {
    ...
    meta: "Reestruturar a plataforma preexistente, cria\xE7\xE3o e forma\xE7\xE3o dos setores, recrutar e capacitar colaboradores, instaurar processos \xE1geis para aumentar a base de clientes.",
    result: "Planejamos e criamos o visual do produto por meio do desenvolvimento de um sistema de design robusto para Web e Mobile e das pr\xE1xis de arquitetura Cloud. Durante a cria\xE7\xE3o do projeto, utilizamos t\xE9cnicas de UX Design, UX Writing, User Research, Discovery, React Native, ReDux Sagas e Microsservi\xE7os.",
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Placerat scelerisque mauris habitasse lacus, a dolor. Scelerisque eleifend feugiat venenatis massa ultricies malesuada vitae pellentesque.",
  ...
  },
  {
    ...
    name: "Seu |Ingresso",
    slogan: "Rede Social Profissional de V\xEDdeo",
    meta: "Desenvolver uma plataforma  Web e Mobile destinada \xE0 cria\xE7\xE3o, organiza\xE7\xE3o e gest\xE3o de eventos para organizadores.",
    result: "Projetamos e elaboramos o visual do produto por meio do desenvolvimento de um sistema de design robusto para Web e Mobile e das pr\xE1xis de arquitetura Cloud. Durante a cria\xE7\xE3o do projeto, utilizamos t\xE9cnicas de UX Design, UX Writing, User Research, Discovery, React Native, ReDux Sagas e Microsservi\xE7os.",
...
var Home = () => {
  ...
  return /* @__PURE__ */ React.createElement(Box_default, {
    ...
    type: "h3",
    title: /* @__PURE__ */ React.createElement(React.Fragment, null, open.name.split("|")[0], /* @__PURE__ */ React.createElement("span", {
      style: {
        color: "#FF710D"
      }
    }, open.name.split("|")[1]))
...
// app/components/ProjectMobile/ProjectMobile.jsx
init_react();

// app/components/ProjectMobile/styles.css
var styles_default6 = "/build/_assets/styles-323FXZMG.css";

// app/components/ProjectMobile/ProjectMobile.jsx
var links6 = [{ rel: "stylesheet", href: styles_default6 }];
var ProjectMobile = ({ data }) => {
  return /* @__PURE__ */ React.createElement(Box_default, {
    className: "dot",
    flex: "1",
    colum: true
  }, /* @__PURE__ */ React.createElement(Box_default, {
    className: "dot_header",
    flex: "1",
    column: true
  }, /* @__PURE__ */ React.createElement(BaseText_default, {
    className: "dot_dot",
    type: "span",
    title: /* @__PURE__ */ React.createElement(React.Fragment, null, data.name.split("|")[0], /* @__PURE__ */ React.createElement("span", {
      style: {
        color: "#FF710D"
      }
    }, data.name.split("|")[1]))
...
ProjectMobile.links = links6;
var ProjectMobile_default = ProjectMobile;

// app/views/Home/HomeMobile.jsx
var links7 = [{ rel: "stylesheet", href: styles_default5 }, ...ProjectMobile_default.links, ...Footer_default.links];
var Home2 = () => {
  return /* @__PURE__ */ React.createElement(Box_default, {
    column: true,
    flex: 1,
    ...
    title: /* @__PURE__ */ React.createElement(React.Fragment, null, "Nossos Recentes ", /* @__PURE__ */ React.createElement("span", null, "Casos"), " de ", /* @__PURE__ */ React.createElement("span", null, "Sucesso")),
    type: "span"
  }), /* @__PURE__ */ React.createElement(Divider_default, {
    type: "h",
    spaccing: "0px",
    ...
    return /* @__PURE__ */ React.createElement(ProjectMobile_default, {
      data: e,
      key: k
    });
...
// app/routes/index.jsx
function links8(data) {
  return [...Home.links, ...Home2.links, ...Footer_default.links, ...Layout.links];
}
function Index() {
  const { mobile } = useLoaderData();
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Header_default, null), /* @__PURE__ */ React.createElement(Layout, {
    scroll: true,
    mobile
  }, mobile ? /* @__PURE__ */ React.createElement(Home2, null) : /* @__PURE__ */ React.createElement(Home, null)), !mobile && /* @__PURE__ */ React.createElement(Footer_default, null));
}
export {
  Index as default,
  links8 as links
 ...
 */
//# sourceMappingURL=/build/routes/index-RNDG2F27.js.map
