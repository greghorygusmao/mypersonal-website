import {
  ...
  useSpring,
  useTransition
} from "/build/_shared/chunk-BCGXVSLA.js";
import {
  require_react_dom
...
var TaskListHeaderDefault = function TaskListHeaderDefault2(_ref) {
  ...
  }, "\xA0Name"), import_react.default.createElement("div", {
  ...
  }, "\xA0From"), import_react.default.createElement("div", {
    className: styles.ganttTable_HeaderSeparator,
    style: {
      height: headerHeight * 0.5,
...
var TaskListTableDefault = function TaskListTableDefault2(_ref) {
  ...
  var toLocaleDateString = (0, import_react.useMemo)(function() {
  ...
  return import_react.default.createElement("div", {
    ...
    }, expanderSymbol), import_react.default.createElement("div", null, t.name))), import_react.default.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth
      }
    }, "\xA0", toLocaleDateString(t.start, dateTimeOptions)), import_react.default.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth
...
var Tooltip = function Tooltip2(_ref) {
  ...
  var _useState = (0, import_react.useState)(0), relatedY = _useState[0], setRelatedY = _useState[1];
  var _useState2 = (0, import_react.useState)(0), relatedX = _useState2[0], setRelatedX = _useState2[1];
  ...
  }, import_react.default.createElement(TooltipContent, {
    task,
    fontSize,
    fontFamily
  }));
...
var StandardTooltipContent = function StandardTooltipContent2(_ref2) {
  ...
  }, task.name + ": " + task.start.getDate() + "-" + (task.start.getMonth() + 1) + "-" + task.start.getFullYear() + " - " + task.end.getDate() + "-" + (task.end.getMonth() + 1) + "-" + task.end.getFullYear()), task.end.getTime() - task.start.getTime() !== 0 && import_react.default.createElement("p", {
    className: styles$2.tooltipDefaultContainerParagraph
  }, "Duration: " + ~~((task.end.getTime() - task.start.getTime()) / (1e3 * 60 * 60 * 24)) + " day(s)"), import_react.default.createElement("p", {
    className: styles$2.tooltipDefaultContainerParagraph
...
var VerticalScroll = function VerticalScroll2(_ref) {
  ...
  var scrollRef = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(function() {
...
var TaskList = function TaskList2(_ref) {
  ...
  var horizontalContainerRef = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(function() {
  ...
  return import_react.default.createElement("div", {
    ref: taskListRef
  }, import_react.default.createElement(TaskListHeader, Object.assign({}, headerProps)), import_react.default.createElement("div", {
    ref: horizontalContainerRef,
    className: horizontalContainerClass,
    style: ganttHeight ? {
      height: ganttHeight
    } : {}
  }, import_react.default.createElement(TaskListTable, Object.assign({}, tableProps))));
};
...
var GridBody = function GridBody2(_ref) {
  ...
  var y = 0;
  var gridRows = [];
  var rowLines = [import_react.default.createElement("line", {
    key: "RowLineFirst",
    x: "0",
    y1: 0,
    x2: svgWidth,
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(tasks), _step; !(_step = _iterator()).done; ) {
    var task = _step.value;
    gridRows.push(import_react.default.createElement("rect", {
      key: "Row" + task.id,
      x: "0",
      y,
      width: svgWidth,
    ...
    rowLines.push(import_react.default.createElement("line", {
      key: "RowLine" + task.id,
      x: "0",
      y1: y + rowHeight,
      x2: svgWidth,
  ...
  var tickX = 0;
  var ticks = [];
  var today = import_react.default.createElement("rect", null);
  for (var i = 0; i < dates.length; i++) {
    var date = dates[i];
    ticks.push(import_react.default.createElement("line", {
      key: date.getTime(),
      x1: tickX,
      y1: 0,
      x2: tickX,
    ...
    if (i + 1 !== dates.length && date.getTime() < now.getTime() && dates[i + 1].getTime() >= now.getTime() || i !== 0 && i + 1 === dates.length && date.getTime() < now.getTime() && addToDate(date, date.getTime() - dates[i - 1].getTime(), "millisecond").getTime() >= now.getTime()) {
      today = import_react.default.createElement("rect", {
        x: tickX,
        y: 0,
        width: columnWidth,
        height: y,
  ...
  return import_react.default.createElement("g", {
    ...
    className: "rows"
  }, gridRows), import_react.default.createElement("g", {
    className: "rowLines"
  }, rowLines), import_react.default.createElement("g", {
    className: "ticks"
  }, ticks), import_react.default.createElement("g", {
    className: "today"
  }, today));
};
var Grid = function Grid2(props) {
  return import_react.default.createElement("g", {
    className: "grid"
  }, import_react.default.createElement(GridBody, Object.assign({}, props)));
};
...
var Calendar = function Calendar2(_ref) {
  ...
  var getCalendarValuesForMonth = function getCalendarValuesForMonth2() {
    ...
    for (var i = 0; i < dateSetup.dates.length; i++) {
      ...
      bottomValues2.push(import_react.default.createElement("text", {
      ...
      if (i === 0 || date.getFullYear() !== dateSetup.dates[i - 1].getFullYear()) {
        ...
        topValues2.push(import_react.default.createElement(TopPartOfCalendar, {
          key: topValue,
          value: topValue,
...
var Bar = function Bar2(_ref) {
  ...
  return import_react.default.createElement("g", {
    ...
    tabIndex: 0
  }, import_react.default.createElement(BarDisplay, {
    x: task.x1,
    y: task.y,
  ...
  }, isDateChangeable && import_react.default.createElement("g", null, import_react.default.createElement(BarDateHandle, {
    x: task.x1 + 1,
    y: task.y + 1,
  ...
  }), import_react.default.createElement(BarDateHandle, {
  ...
  })), isProgressChangeable && import_react.default.createElement(BarProgressHandle, {
    progressPoint,
    onMouseDown: function onMouseDown(e) {
...
var TaskItem = function TaskItem2(props) {
  ...
  var textRef = (0, import_react.useRef)(null);
  var _useState = (0, import_react.useState)(import_react.default.createElement("div", null)), taskItem = _useState[0], setTaskItem = _useState[1];
  var _useState2 = (0, import_react.useState)(true), isTextInside = _useState2[0], setIsTextInside = _useState2[1];
  (0, import_react.useEffect)(function() {
    switch (task.typeInternal) {
      case "milestone":
        setTaskItem(import_react.default.createElement(Milestone, Object.assign({}, props)));
        break;
      case "project":
        setTaskItem(import_react.default.createElement(Project, Object.assign({}, props)));
        break;
      case "smalltask":
        setTaskItem(import_react.default.createElement(BarSmall, Object.assign({}, props)));
        break;
      default:
        setTaskItem(import_react.default.createElement(Bar, Object.assign({}, props)));
        break;
    }
  }, [task, isSelected]);
  (0, import_react.useEffect)(function() {
  ...
  }, taskItem, import_react.default.createElement("text", {
    x: getX(),
...
var TaskGanttContent = function TaskGanttContent2(_ref) {
  ...
  var _useState = (0, import_react.useState)(0), xStep = _useState[0], setXStep = _useState[1];
  var _useState2 = (0, import_react.useState)(0), initEventX1Delta = _useState2[0], setInitEventX1Delta = _useState2[1];
  var _useState3 = (0, import_react.useState)(false), isMoving = _useState3[0], setIsMoving = _useState3[1];
  (0, import_react.useEffect)(function() {
    var dateDelta = dates[1].getTime() - dates[0].getTime() - dates[1].getTimezoneOffset() * 60 * 1e3 + dates[0].getTimezoneOffset() * 60 * 1e3;
  ...
  return import_react.default.createElement("g", {
    ...
    return import_react.default.createElement(TaskItem, {
      task,
      arrowIndent,
      taskHeight,
...
var TaskGantt = function TaskGantt2(_ref) {
  ...
  var ganttSVGRef = (0, import_react.useRef)(null);
  var horizontalContainerRef = (0, import_react.useRef)(null);
  var verticalGanttContainerRef = (0, import_react.useRef)(null);
  ...
  return import_react.default.createElement("div", {
  ...
  }, import_react.default.createElement(Calendar, Object.assign({}, calendarProps))), import_react.default.createElement("div", {
    ref: horizontalContainerRef,
    ...
    fontFamily: barProps.fontFamily,
    ref: ganttSVGRef
  }, import_react.default.createElement(Grid, Object.assign({}, gridProps)), import_react.default.createElement(TaskGanttContent, Object.assign({}, newBarProps)))));
};
...
var Gantt = function Gantt2(_ref) {
  ...
  var taskListRef = (0, import_react.useRef)(null);
  ...
  var _useState2 = (0, import_react.useState)(rowHeight * barFill / 100), taskHeight = _useState2[0], setTaskHeight = _useState2[1];
  var _useState3 = (0, import_react.useState)(0), taskListWidth = _useState3[0], setTaskListWidth = _useState3[1];
  var _useState4 = (0, import_react.useState)(0), svgContainerWidth = _useState4[0], setSvgContainerWidth = _useState4[1];
  var _useState5 = (0, import_react.useState)(ganttHeight), svgContainerHeight = _useState5[0], setSvgContainerHeight = _useState5[1];
  var _useState6 = (0, import_react.useState)([]), barTasks = _useState6[0], setBarTasks = _useState6[1];
  var _useState7 = (0, import_react.useState)({
    action: ""
  }), ganttEvent = _useState7[0], setGanttEvent = _useState7[1];
  var _useState8 = (0, import_react.useState)(), selectedTask = _useState8[0], setSelectedTask = _useState8[1];
  var _useState9 = (0, import_react.useState)(null), failedTask = _useState9[0], setFailedTask = _useState9[1];
  var svgWidth = dateSetup.dates.length * columnWidth;
  var ganttFullHeight = barTasks.length * rowHeight;
  var _useState10 = (0, import_react.useState)(0), scrollY = _useState10[0], setScrollY = _useState10[1];
  var _useState11 = (0, import_react.useState)(-1), scrollX = _useState11[0], setScrollX = _useState11[1];
  var _useState12 = (0, import_react.useState)(false), ignoreScrollEvent = _useState12[0], setIgnoreScrollEvent = _useState12[1];
  (0, import_react.useEffect)(function() {
    var filteredTasks;
    if (onExpanderClick) {
  ...
  return import_react.default.createElement("div", null, import_react.default.createElement("div", {
    ...
    tabIndex: 0,
    ref: wrapperRef
  }, listCellWidth && import_react.default.createElement(TaskList, Object.assign({}, tableProps)), import_react.default.createElement(TaskGantt, {
    gridProps,
    calendarProps,
    barProps,
    ganttHeight,
    scrollY,
    scrollX
  }), ganttEvent.changedTask && import_react.default.createElement(Tooltip, {
    arrowIndent,
    rowHeight,
    svgContainerHeight,
    svgContainerWidth,
    ...
    rtl,
    svgWidth
  }), import_react.default.createElement(VerticalScroll, {
    ganttFullHeight,
    ganttHeight,
    headerHeight,
    scroll: scrollY,
    ...
    rtl
  })), import_react.default.createElement(HorizontalScroll, {
    svgWidth,
    taskListWidth,
    scroll: scrollX,
    rtl,
...
var BaseText = ({
  ...
  return /* @__PURE__ */ import_react2.default.createElement(CustomTag, {
    className: `${className || ""}`,
    style: style2,
    title: aria,
    ...hrefProp,
...
var Icon = ({ style: style2, name, className = "", onClick }) => {
  return /* @__PURE__ */ import_react4.default.createElement("i", {
...
var Modal = ({
  ...
  const content = (0, import_react5.useRef)(null);
  ...
  return transition((item, props) => item && /* @__PURE__ */ import_react5.default.createElement("div", {
    className: "modalctn"
  }, /* @__PURE__ */ import_react5.default.createElement(animated.div, {
...
var ModalPortal = (props) => createUniversalPortal(/* @__PURE__ */ import_react5.default.createElement(Modal, {
  ...props
}), "body");
...
var ColumnCards = ({ data, style: style2 }) => {
  const [finish, setFinish] = (0, import_react6.useState)([]);
  const [process, setProcess] = (0, import_react6.useState)([]);
  (0, import_react6.useEffect)(() => {
    let processTmp = data?.data?.process?.map((e) => {
      return /* @__PURE__ */ React.createElement(Card, {
        data: e,
        key: e.id
      });
    });
    let finishTmp = data?.data?.finish?.map((e) => {
      return /* @__PURE__ */ React.createElement(Card, {
        data: e,
        key: e.id
      });
  ...
  return /* @__PURE__ */ React.createElement(Box_default, {
    ...
    type: "span",
    title: "EM PROCESSO"
  }), /* @__PURE__ */ React.createElement("div", null, process)), /* @__PURE__ */ React.createElement(Divider_default, {
    type: "h",
    spaccing: "0px",
    style: { backgroundColor: "#EBEBED" }
  }), /* @__PURE__ */ React.createElement(Box_default, {
    ...
    type: "span",
    title: "CONCLUIDOS"
  }), /* @__PURE__ */ React.createElement("div", null, finish))));
};
...
//# sourceMappingURL=/build/routes/index-RLWOQSTY.js.map
