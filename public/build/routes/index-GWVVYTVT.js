...
var Card = ({ data }) => {
  const labels2 = (0, import_react4.useMemo)(() => {
  ...
  return /* @__PURE__ */ React.createElement(Box_default, {
    ...
    flex: 1,
    alignItems: "center"
  }, labels2), /* @__PURE__ */ React.createElement(Box_default, {
    flexDirection: "row"
...
var ColumnCards = ({ data, style }) => {
  ...
  return /* @__PURE__ */ React.createElement(Box_default, {
    ...
    type: "span",
    title: "EM PROCESSO"
  }), /* @__PURE__ */ React.createElement("div", null, dataFiltered?.proccess?.sort((a, b) => {
    ...
    type: "span",
    title: "CONCLUIDOS"
  }), /* @__PURE__ */ React.createElement("div", null, dataFiltered?.finish?.sort((a, b) => {
    return a.priorityOrder < b.priorityOrder;
  })?.map((e) => {
    return /* @__PURE__ */ React.createElement(Card, {
      data: e,
...
//# sourceMappingURL=/build/routes/index-GWVVYTVT.js.map
