...
var ColumnCards = ({ data, style }) => {
  const dataFiltered = (0, import_react4.useMemo)(() => {
    let finish = [];
    let process = [];
    process = finish = data?.data?.finish?.sort((a, b) => {
  ...
  return /* @__PURE__ */ React.createElement(Box_default, {
    ...
    type: "span",
    title: "EM PROCESSO"
  }), /* @__PURE__ */ React.createElement("div", null, data?.data?.process?.sort((a, b) => {
    return a.priorityOrder > b.priorityOrder;
  })?.map((e) => {
    return /* @__PURE__ */ React.createElement(Card, {
      data: e,
...
//# sourceMappingURL=/build/routes/index-EMSJ56BE.js.map
