...
function useTransitionHeight(initialValue = false, collpase = 0) {
  const [active2, toggle] = (0, import_react15.useState)(initialValue);
  const previous = usePrevious(active2);
  const [bind, { height: viewHeight }] = useMeasure();
  const { height } = useSpring({
    from: { height: collpase },
    to: { height: active2 ? viewHeight : collpase }
  });
  return [
    {
      height,
...
var Project = ({ active: active2, changeOpen }) => {
  ...
  return /* @__PURE__ */ React.createElement(Box_default, {
    className: clsx_m_default("companyinfodefault", active2 && "active"),
    column: true,
    onClick: () => {
      changeOpen();
    }
...
var Home = () => {
  ...
  const projects = (0, import_react17.useMemo)(() => {
...
***************************************************************************** */
//# sourceMappingURL=/build/routes/index-CMIJ34HZ.js.map
