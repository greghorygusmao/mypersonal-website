...
var Card = ({ data }) => {
  return /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.card,
    flex: "1",
    justifyContent: "flex-start",
    alignItems: "flex-start",
    flexDirection: "row"
  }, /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.card_infocard,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "column"
  }, /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.card_header,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "column"
  }, /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.card_tags,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "row"
  }), /* @__PURE__ */ React.createElement(BaseText_default, {
    className: styles_default.card_reconstruoregistrocorreodeponto,
    type: "span",
    title: "Reconstru\xE7\xE3o Registro/Corre\xE7\xE3o de Ponto"
  })), /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.card_info,
    flex: "1",
    justifyContent: "flex-start",
    alignItems: "center",
    flexDirection: "row"
  }, /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.card_deadline,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "row"
  }, /* @__PURE__ */ React.createElement(Icon_default2, {
    name: "icon-icon_calendar",
    className: styles_default.card_icon_calendar
  }), /* @__PURE__ */ React.createElement(BaseText_default, {
    className: styles_default.card_,
    type: "span",
    title: "20/12/2021"
  })), /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.card_priority,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "row"
    ...
    className: styles_default.card_icon_alert
  }), /* @__PURE__ */ React.createElement(BaseText_default, {
    className: styles_default.card_baixa,
    type: "span",
    title: "Baixa"
  })), /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.card_trello,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "row"
  }, /* @__PURE__ */ React.createElement(Icon_default2, {
    name: "icon-card_icon_trello",
    className: styles_default.card_icon_trello
  }), /* @__PURE__ */ React.createElement(BaseText_default, {
    className: styles_default.card_cardtrello,
    type: "span",
    title: "Card Trello"
  })))));
};
 ...
 */
//# sourceMappingURL=/build/routes/index-NTABERO3.js.map
