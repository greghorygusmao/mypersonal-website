...
var useScroll = ({ reRender = false }) => {
  ...
  (0, import_react5.useEffect)(() => {
    if (!render) {
      scroll && scroll?.scrollTo(0, 0, 0, void 0, true);
...
function Index() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(LeftNavbar, null), /* @__PURE__ */ React.createElement(Layout, null, /* @__PURE__ */ React.createElement(import_react_router.Outlet, null)));
}
export {
  Index as default,
  links4 as links
};
//# sourceMappingURL=/build/routes/cms-DVC73YZA.js.map
