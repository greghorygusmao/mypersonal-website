...
// app/components/Hooks/useVirtualList.js
var useVirtualList = ({ ref: ref2, size, items = [], service, cursorItems }) => {
  const parentRef = ref2;
...
var Items = ({ children, service, items }) => {
  ...
  console.log(parentRef);
  const [isLoading, rowVirtualizer] = useVirtualList({ service, items, ref });
...
//# sourceMappingURL=/build/routes/cms/blog-AUMQAMR6.js.map
