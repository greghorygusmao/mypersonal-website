...
var Items = ({ children, service, items, height = "70vh", size = 40 }) => {
  ...
  console.log(items);
  const [isLoading, rowVirtualizer] = useVirtualList({
    service,
    size,
    items: items?.data?.edges,
    cursorItems: items?.data?.pageInfo,
    ref: parentRef
  });
...
//# sourceMappingURL=/build/routes/cms/blog-BHITN7CL.js.map
