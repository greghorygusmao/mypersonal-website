...
var Items = ({ children, service, items }) => {
  ...
  const [isLoading, rowVirtualizer] = useVirtualList({
    ...
    items,
    ref: parentRef,
    windowRef: canUseDOM() ? document.body.querySelector("#scroll") : null
  });
  console.log(canUseDOM() ? document.body.querySelector("#scroll") : null);
...
//# sourceMappingURL=/build/routes/cms/blog-7H52YEQW.js.map
