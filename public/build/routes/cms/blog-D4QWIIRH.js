...
function useVirtual(_ref) {
  ...
  useIsomorphicLayoutEffect(function() {
    ...
    var onScroll = function onScroll2(event2) {
      var offset = scrollOffsetFnRef.current ? scrollOffsetFnRef.current(event2) : element[scrollKey];
...
var Items = ({ children, service, items, height = "70vh", size = 40 }) => {
  const parentRef = (0, import_react4.useRef)(null);
  const [isLoading, rowVirtualizer] = useVirtualList({ service, size, items, ref: parentRef });
...
//# sourceMappingURL=/build/routes/cms/blog-D4QWIIRH.js.map
