...
Divider.propTypes = {
  ...
  spaccing: import_prop_types3.default.string,
  variant: import_prop_types3.default.string
};
var Divider_default = Divider;

// app/components/ColumnCards/styles.css
var styles_default = "/build/_assets/styles-PR5FXTHA.css";

// app/components/ColumnCards/ColumnCards.jsx
var links = [{ rel: "stylesheet", href: styles_default }];
var Card = ({ data }) => {
  return /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.cards,
    flex: "1",
    justifyContent: "center",
    alignItems: "center",
    flexDirection: "column"
  }, /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.cards_card,
    flex: "1",
    justifyContent: "flex-start",
    alignItems: "flex-start",
    flexDirection: "row"
  }, /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.cards_infocard,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "column"
  }, /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.cards_header,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "column"
  }, /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.cards_tags,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "row"
  }), /* @__PURE__ */ React.createElement(BaseText_default, {
    className: styles_default.cards_reconstruoregistrocorreodeponto,
    type: "span",
    title: "Reconstru\xE7\xE3o Registro/Corre\xE7\xE3o de Ponto"
  })), /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.cards_info,
    flex: "1",
    justifyContent: "flex-start",
    alignItems: "center",
    flexDirection: "row"
  }, /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.cards_deadline,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "row"
    ...
    name: "undefined",
    className: styles_default.cards_icon_calendar
  }), /* @__PURE__ */ React.createElement(BaseText_default, {
    className: styles_default.cards_,
    type: "span",
    title: "20/12/2021"
  })), /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.cards_priority,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "row"
    ...
    name: "undefined",
    className: styles_default.cards_icon_alert
  }), /* @__PURE__ */ React.createElement(BaseText_default, {
    className: styles_default.cards_baixa,
    type: "span",
    title: "Baixa"
  })), /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.cards_trello,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "row"
    ...
    name: "undefined",
    className: styles_default.cards_icon_trello
  }), /* @__PURE__ */ React.createElement(BaseText_default, {
    className: styles_default.cards_cardtrello,
    type: "span",
    title: "Card Trello"
  }))))));
};
var ColumnCards = ({ data, style }) => {
  ...
  return /* @__PURE__ */ React.createElement(Box_default, {
    ...
    type: "span",
    title: "EM PROCESSO"
  }), /* @__PURE__ */ React.createElement("div", null, data?.data?.map((e) => {
...
var wrapAsElement = function wrapAsElement2(css2, names) {
  return function() {
    ...
    return import_react5.default.createElement("style", _extends({}, props, { dangerouslySetInnerHTML: { __html: css2() } }));
  };
};
...
var StyleSheet = function() {
  ...
  StyleSheet2.prototype.toReactElements = function toReactElements() {
    ...
    return this.tags.map(function(tag, i) {
      var key = "sc-" + id + "-" + i;
      return (0, import_react5.cloneElement)(tag.toElement(), { key });
    });
  };
...
var ThemeContext = (0, import_react5.createContext)();
...
var ThemeProvider = function(_Component) {
  ...
  ThemeProvider2.prototype.render = function render() {
    if (!this.props.children)
      return null;
    return import_react5.default.createElement(ThemeContext.Consumer, null, this.renderInner);
  };
  ThemeProvider2.prototype.renderInner = function renderInner(outerTheme) {
    var context = this.getContext(this.props.theme, outerTheme);
    return import_react5.default.createElement(ThemeContext.Provider, { value: context }, this.props.children);
  };
...
var ServerStyleSheet = function() {
  ...
  ServerStyleSheet2.prototype.collectStyles = function collectStyles(children) {
    ...
    return import_react5.default.createElement(StyleSheetManager, { sheet: this.instance }, children);
  };
...
var StyleSheetContext = (0, import_react5.createContext)();
...
var StyleSheetManager = function(_Component) {
  ...
  StyleSheetManager2.prototype.render = function render() {
    ...
    return import_react5.default.createElement(StyleSheetContext.Provider, { value: this.getContext(sheet, target) }, true ? import_react5.default.Children.only(children) : children);
  };
  return StyleSheetManager2;
}(import_react5.Component);
true ? StyleSheetManager.propTypes = {
  sheet: import_prop_types4.default.oneOfType([import_prop_types4.default.instanceOf(StyleSheet), import_prop_types4.default.instanceOf(ServerStyleSheet)]),
  target: import_prop_types4.default.shape({
    appendChild: import_prop_types4.default.func.isRequired
  })
} : void 0;
var identifiers = {};
...
` + ("For example, { " + key + ": () => InnerComponent } instead of { " + key + ": InnerComponent }"));
  ...
  StyledComponent2.prototype.render = function render() {
    return import_react5.default.createElement(StyleSheetConsumer, null, this.renderOuter);
  };
  StyledComponent2.prototype.renderOuter = function renderOuter() {
    ...
    return import_react5.default.createElement(ThemeConsumer, null, this.renderInner);
  };
  StyledComponent2.prototype.renderInner = function renderInner(theme) {
    ...
    return (0, import_react5.createElement)(elementToBeCreated, propsForElement);
  };
      ...
      for (key in resolvedAttrDef) {
        ...
        if (!attrDefWasFn) {
          if (isFunction(attr) && !isDerivedReactComponent(attr) && !isStyledComponent(attr)) {
            ...
            attr = attr(context);
            if (import_react5.default.isValidElement(attr)) {
...
function createStyledComponent(target, options, rules) {
  ...
  var forwardRef2 = function forwardRef3(props, ref) {
    return import_react5.default.createElement(ParentComponent, _extends({}, props, { forwardedComponent: WrappedStyledComponent, forwardedRef: ref }));
  };
  forwardRef2.displayName = displayName;
  WrappedStyledComponent = import_react5.default.forwardRef(forwardRef2);
...
var possibleConstructorReturn2 = function(self, call) {
  if (!self) {
    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  }
  return call && (typeof call === "object" || typeof call === "function") ? call : self;
...
var Loader = function Loader2(_ref) {
  ...
  return import_react6.default.createElement(Wrapper, {
    isOnTop,
    hasLoaded,
    transitionTime
  });
...
Loader.propTypes = {
  isOnTop: import_prop_types5.default.bool,
  hasLoaded: import_prop_types5.default.bool,
  transitionTime: import_prop_types5.default.string
};
Loader.defaultProps = {
...
var ImageLoader = function(_React$Component) {
  ...
  createClass2(ImageLoader2, [{
    ...
    value: function render() {
      ...
      return lazyLoad ? import_react6.default.createElement(import_react_visibility_sensor.default, {
...
ImageLoader.propTypes = {
  src: import_prop_types5.default.string.isRequired,
  transitionTime: import_prop_types5.default.string,
  lazyLoad: import_prop_types5.default.bool,
  children: import_prop_types5.default.oneOfType([import_prop_types5.default.arrayOf(import_prop_types5.default.node), import_prop_types5.default.node, import_prop_types5.default.func])
};
...
var BackgroundImage = function BackgroundImage2(_ref) {
  ...
  return import_react6.default.createElement(ImageLoader, { src, transitionTime, lazyLoad }, function(_ref2) {
    ...
    if (useChild) {
      ...
      childElement = import_react6.default.cloneElement(children, { style });
    } else {
      ...
      hasLoaded ? style = _extends2({}, style, backgroundImageStyle) : style;
      childElement = import_react6.default.createElement(element, _extends2({}, props, { style }), children);
    }
    return import_react6.default.createElement(Wrapper$2, {
      width,
      height,
      isResponsive,
      className: wrapperClassName
    }, childElement, shouldShowLoader && !disableLoader && import_react6.default.createElement(import_react6.Fragment, null, renderLoader ? renderLoader({ hasLoaded, hasFailed }) : import_react6.default.createElement(Loader, {
      isOnTop: true,
      hasLoaded,
      transitionTime
    })));
...
BackgroundImage.propTypes = {
  ...
  transitionTime: import_prop_types5.default.string,
  renderLoader: import_prop_types5.default.func,
  disableLoader: import_prop_types5.default.bool,
  useChild: import_prop_types5.default.bool,
  ...
  wrapperClassName: import_prop_types5.default.string,
  lazyLoad: import_prop_types5.default.bool,
  isResponsive: import_prop_types5.default.bool
};
...
var Image2 = function Image3(_ref) {
  ...
  return isResponsive ? import_react6.default.createElement(BackgroundImage, _extends2({
    src,
    width,
    height,
    transitionTime,
    ...
    lazyLoad,
    isResponsive: true
  }, props)) : import_react6.default.createElement(ImageLoader, { src, transitionTime, lazyLoad }, function(_ref2) {
    var hasLoaded = _ref2.hasLoaded, shouldShowLoader = _ref2.shouldShowLoader, hasFailed = _ref2.hasFailed, src2 = _ref2.src;
    return import_react6.default.createElement(Wrapper$1, { width, height, className: wrapperClassName }, hasLoaded && import_react6.default.createElement(Img, _extends2({ src: src2, transitionTime }, props)), shouldShowLoader && !disableLoader && import_react6.default.createElement(import_react6.Fragment, null, renderLoader ? renderLoader({ hasLoaded, hasFailed }) : import_react6.default.createElement(Loader, null)));
  });
};
Image2.propTypes = {
  src: import_prop_types5.default.string.isRequired,
...
var BaseImage = ({
  ...
  const ImageComponent = (0, import_react7.useMemo)(() => {
    return backGroundMode ? /* @__PURE__ */ import_react7.default.createElement(BackgroundImage, {
      className: `${className || ""}`,
      style: {
      ...
      title,
      disableLoader
    }) : /* @__PURE__ */ import_react7.default.createElement(Image2, {
      className: `${className || ""}`,
      style,
      src,
      width,
...
BaseImage.propTypes = {
  ...
  backGroundMode: import_prop_types6.default.bool
};
...
var Icon2 = ({ style, name, className = "", onClick }) => {
  return /* @__PURE__ */ import_react8.default.createElement("i", {
...
var styles_default3 = "/build/_assets/styles-JTFYZ53L.css";
 ...
 */
//# sourceMappingURL=/build/routes/index-QRC5HNLN.js.map
