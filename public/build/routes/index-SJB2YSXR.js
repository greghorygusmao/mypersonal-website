...
var BaseText = ({ title, children, style, className, onClick, type, aria, target, href }) => {
  ...
  return /* @__PURE__ */ import_react9.default.createElement(CustomTag, {
    className: `${className || ""}`,
    style,
    title: aria,
    ...hrefProp,
...
var styles_default = "/build/_assets/styles-LBKXBFBD.css";
...
***************************************************************************** */
//# sourceMappingURL=/build/routes/index-SJB2YSXR.js.map
