...
function useTransitionHeight(initialValue = false, collpase = 0, controlled = false, activeOut = false) {
...
var Project = ({ active, changeOpen }) => {
  const [hAnimated, bind, toggle, height, previous] = useTransitionHeight(false, 0, true, active);
  return /* @__PURE__ */ React.createElement(Box_default, {
...
***************************************************************************** */
//# sourceMappingURL=/build/routes/index-5R6SZ6HI.js.map
