...
import {
  SmoothScrollContext
} from "/build/_shared/chunk-B43B2T5C.js";
import {
...
function useForceUpdate() {
  ...
  const mounted = (0, import_react7.useState)(makeMountedRef)[0];
...
var useLayoutEffect2 = typeof window !== "undefined" && window.document && window.document.createElement ? React4.useLayoutEffect : React4.useEffect;
...
var withAnimated = (Component2, host2) => {
  ...
  return (0, import_react8.forwardRef)((givenProps, givenRef) => {
    ...
    return React5.createElement(Component2, _extends2({}, usedProps, {
      ref
    }));
  });
};
...
function useSprings(length, props, deps) {
  ...
  const context = (0, import_react9.useContext)(SpringContext);
...
function useTransition(data, props, deps) {
  ...
  const transitions = [];
  const usedTransitions = (0, import_react9.useRef)(null);
  ...
  const exitingTransitions = (0, import_react9.useRef)(new Map());
  const forceChange = (0, import_react9.useRef)(false);
  ...
  const renderTransitions = (render) => React6.createElement(React6.Fragment, null, transitions.map((t, i) => {
    const {
      springs
    } = changes.get(t) || t.ctrl;
    const elem = render(_extends3({}, springs), t.item, t, i);
    return elem && elem.type ? React6.createElement(elem.type, _extends3({}, elem.props, {
...
var wrapAsElement = function wrapAsElement2(css2, names) {
  return function() {
    ...
    return import_react10.default.createElement("style", _extends4({}, props, { dangerouslySetInnerHTML: { __html: css2() } }));
  };
};
...
var StyleSheet = function() {
  ...
  StyleSheet2.prototype.toReactElements = function toReactElements() {
    ...
    return this.tags.map(function(tag, i) {
      var key = "sc-" + id + "-" + i;
      return (0, import_react10.cloneElement)(tag.toElement(), { key });
    });
  };
...
var ThemeProvider = function(_Component) {
  ...
  ThemeProvider2.prototype.render = function render() {
    if (!this.props.children)
      return null;
    return import_react10.default.createElement(ThemeContext.Consumer, null, this.renderInner);
  };
  ThemeProvider2.prototype.renderInner = function renderInner(outerTheme) {
    var context = this.getContext(this.props.theme, outerTheme);
    return import_react10.default.createElement(ThemeContext.Provider, { value: context }, this.props.children);
  };
...
var ServerStyleSheet = function() {
  ...
  ServerStyleSheet2.prototype.collectStyles = function collectStyles(children) {
    ...
    return import_react10.default.createElement(StyleSheetManager, { sheet: this.instance }, children);
  };
...
var StyleSheetContext = (0, import_react10.createContext)();
...
var StyleSheetManager = function(_Component) {
  ...
  StyleSheetManager2.prototype.render = function render() {
    ...
    return import_react10.default.createElement(StyleSheetContext.Provider, { value: this.getContext(sheet, target) }, true ? import_react10.default.Children.only(children) : children);
  };
...
` + ("For example, { " + key + ": () => InnerComponent } instead of { " + key + ": InnerComponent }"));
  ...
  StyledComponent2.prototype.render = function render() {
    return import_react10.default.createElement(StyleSheetConsumer, null, this.renderOuter);
  };
  StyledComponent2.prototype.renderOuter = function renderOuter() {
    ...
    return import_react10.default.createElement(ThemeConsumer, null, this.renderInner);
  };
  StyledComponent2.prototype.renderInner = function renderInner(theme) {
    ...
    return (0, import_react10.createElement)(elementToBeCreated, propsForElement);
  };
      ...
      for (key in resolvedAttrDef) {
        ...
        if (!attrDefWasFn) {
          if (isFunction(attr) && !isDerivedReactComponent(attr) && !isStyledComponent(attr)) {
            ...
            attr = attr(context);
            if (import_react10.default.isValidElement(attr)) {
...
function createStyledComponent(target, options, rules) {
  ...
  var forwardRef3 = function forwardRef4(props, ref) {
    return import_react10.default.createElement(ParentComponent, _extends4({}, props, { forwardedComponent: WrappedStyledComponent, forwardedRef: ref }));
  };
  forwardRef3.displayName = displayName;
  WrappedStyledComponent = import_react10.default.forwardRef(forwardRef3);
...
var ImageLoader = function(_React$Component) {
  ...
  createClass2(ImageLoader2, [{
    ...
    value: function render() {
      ...
      return lazyLoad ? import_react11.default.createElement(import_react_visibility_sensor.default, {
...
var BackgroundImage = function BackgroundImage2(_ref) {
  ...
  return import_react11.default.createElement(ImageLoader, { src, transitionTime, lazyLoad }, function(_ref2) {
    ...
    if (useChild) {
      ...
      childElement = import_react11.default.cloneElement(children, { style });
    } else {
      ...
      hasLoaded ? style = _extends5({}, style, backgroundImageStyle) : style;
      childElement = import_react11.default.createElement(element, _extends5({}, props, { style }), children);
    }
    return import_react11.default.createElement(Wrapper$2, {
      width,
      height,
      isResponsive,
      className: wrapperClassName
    }, childElement, shouldShowLoader && !disableLoader && import_react11.default.createElement(import_react11.Fragment, null, renderLoader ? renderLoader({ hasLoaded, hasFailed }) : import_react11.default.createElement(Loader, {
      isOnTop: true,
      hasLoaded,
      transitionTime
    })));
...
var Image2 = function Image3(_ref) {
  ...
  return isResponsive ? import_react11.default.createElement(BackgroundImage, _extends5({
    src,
    width,
    height,
    transitionTime,
    ...
    lazyLoad,
    isResponsive: true
  }, props)) : import_react11.default.createElement(ImageLoader, { src, transitionTime, lazyLoad }, function(_ref2) {
    var hasLoaded = _ref2.hasLoaded, shouldShowLoader = _ref2.shouldShowLoader, hasFailed = _ref2.hasFailed, src2 = _ref2.src;
    return import_react11.default.createElement(Wrapper$1, { width, height, className: wrapperClassName }, hasLoaded && import_react11.default.createElement(Img, _extends5({ src: src2, transitionTime }, props)), shouldShowLoader && !disableLoader && import_react11.default.createElement(import_react11.Fragment, null, renderLoader ? renderLoader({ hasLoaded, hasFailed }) : import_react11.default.createElement(Loader, null)));
  });
};
Image2.propTypes = {
  src: import_prop_types4.default.string.isRequired,
...
var BaseImage2 = ({
  ...
  const ImageComponent = (0, import_react12.useMemo)(() => {
    return backGroundMode ? /* @__PURE__ */ import_react12.default.createElement(BackgroundImage, {
      className: `${className || ""}`,
      style: {
        backgroundSize: "cover",
        backgroundPosition: "center",
      ...
      title,
      disableLoader
    }) : /* @__PURE__ */ import_react12.default.createElement(Image2, {
      className: `${className || ""}`,
      style,
      src,
      width,
...
var BaseImage_default = BaseImage2;
...
var styles_default2 = "/build/_assets/styles-7AH36BWT.css";
...
// app/components/Hooks/usePortal.js
init_react();
...
function usePortal(id) {
  const rootElemRef = (0, import_react15.useRef)(null);
  (0, import_react15.useEffect)(function setupElement() {
...
var Portal = ({ id, children }) => {
  const target = canUseDOM() ? usePortal(id) : null;
  return target ? (0, import_react_dom3.createPortal)(children, target) : null;
};
...
var styles_default3 = "/build/_assets/styles-F2PYDVR2.css";
...
function useMeasure() {
  ...
  const [bounds, set] = (0, import_react16.useState)({ left: 0, top: 0, width: 0, height: 0 });
  const [ro] = (0, import_react16.useState)(() => new ResizeObserver_es_default(([entry]) => set(entry.contentRect)));
  (0, import_react16.useEffect)(() => ro.observe(ref.current), []);
  return [{ ref }, bounds];
}
function usePrevious(value) {
  const ref = (0, import_react16.useRef)();
  (0, import_react16.useEffect)(() => void (ref.current = value), [value]);
  return ref.current;
}
function useTransitionHeight(initialValue = false, collpase = 0) {
  const [active, toggle] = (0, import_react16.useState)(initialValue);
...
var Project = ({ active, data, changeOpen }) => {
  ...
  const [, updateState] = (0, import_react17.useState)();
  const forceUpdate = (0, import_react17.useCallback)(() => updateState({}), []);
...
Project.links = links3;
var Project_default = Project;

// app/views/Home/styles.css
var styles_default4 = "/build/_assets/styles-ZC5AB3SZ.css";

// app/views/Home/Home.jsx
var links4 = [{ rel: "stylesheet", href: styles_default4 }, ...Project_default.links, ...Footer_default.links];
var PROJECTS = [
  {
    id: 0,
    name: "Dot8",
...
var Home = () => {
  const [open, setOpen] = (0, import_react18.useState)(PROJECTS[0]);
 ...
 */
//# sourceMappingURL=/build/routes/index-V5R7JESO.js.map
