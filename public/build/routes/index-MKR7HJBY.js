...
var ColumnCards = ({ data }) => {
  return /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.inovation,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "column"
  }, /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.inovation_headerlist,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "row"
  }, /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.inovation_title,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "row"
  }, /* @__PURE__ */ React.createElement(BaseText_default, {
    className: styles_default.inovation_,
    type: "span",
    title: "\u{1F4A1}"
  }), /* @__PURE__ */ React.createElement(BaseText_default, {
    className: styles_default.inovation_inovao,
    type: "span",
    title: data.title
  })), /* @__PURE__ */ React.createElement(Box_default, {
    className: styles_default.inovation_number,
    flex: "1",
    ...
    className: styles_default.inovation_inprocess,
    flex: "1",
    justifyContent: "flex-end",
    alignItems: "center",
    flexDirection: "column"
  }, /* @__PURE__ */ React.createElement(BaseText_default, {
    className: styles_default.inovation_emprocesso,
    type: "span",
    title: "EM PROCESSO"
    ...
    className: styles_default.inovation_completed,
    flex: "1",
    justifyContent: "center",
    alignItems: "center",
    flexDirection: "column"
  }, /* @__PURE__ */ React.createElement(BaseText_default, {
    className: styles_default.inovation_concluidos,
    type: "span",
    title: "CONCLUIDOS"
  })));
};
...
var wrapAsElement = function wrapAsElement2(css2, names) {
  return function() {
    ...
    return import_react4.default.createElement("style", _extends({}, props, { dangerouslySetInnerHTML: { __html: css2() } }));
  };
};
...
var StyleSheet = function() {
  ...
  StyleSheet2.prototype.toReactElements = function toReactElements() {
    ...
    return this.tags.map(function(tag, i) {
      var key = "sc-" + id + "-" + i;
      return (0, import_react4.cloneElement)(tag.toElement(), { key });
    });
  };
...
var ThemeProvider = function(_Component) {
  ...
  ThemeProvider2.prototype.render = function render() {
    if (!this.props.children)
      return null;
    return import_react4.default.createElement(ThemeContext.Consumer, null, this.renderInner);
  };
  ThemeProvider2.prototype.renderInner = function renderInner(outerTheme) {
    var context = this.getContext(this.props.theme, outerTheme);
    return import_react4.default.createElement(ThemeContext.Provider, { value: context }, this.props.children);
  };
...
var ServerStyleSheet = function() {
  ...
  ServerStyleSheet2.prototype.collectStyles = function collectStyles(children) {
    ...
    return import_react4.default.createElement(StyleSheetManager, { sheet: this.instance }, children);
  };
...
var StyleSheetContext = (0, import_react4.createContext)();
...
var StyleSheetManager = function(_Component) {
  ...
  StyleSheetManager2.prototype.render = function render() {
    ...
    return import_react4.default.createElement(StyleSheetContext.Provider, { value: this.getContext(sheet, target) }, true ? import_react4.default.Children.only(children) : children);
  };
...
` + ("For example, { " + key + ": () => InnerComponent } instead of { " + key + ": InnerComponent }"));
  ...
  StyledComponent2.prototype.render = function render() {
    return import_react4.default.createElement(StyleSheetConsumer, null, this.renderOuter);
  };
  StyledComponent2.prototype.renderOuter = function renderOuter() {
    ...
    return import_react4.default.createElement(ThemeConsumer, null, this.renderInner);
  };
  StyledComponent2.prototype.renderInner = function renderInner(theme) {
    ...
    return (0, import_react4.createElement)(elementToBeCreated, propsForElement);
  };
      ...
      for (key in resolvedAttrDef) {
        ...
        if (!attrDefWasFn) {
          if (isFunction(attr) && !isDerivedReactComponent(attr) && !isStyledComponent(attr)) {
            ...
            attr = attr(context);
            if (import_react4.default.isValidElement(attr)) {
...
function createStyledComponent(target, options, rules) {
  ...
  var forwardRef2 = function forwardRef3(props, ref) {
    return import_react4.default.createElement(ParentComponent, _extends({}, props, { forwardedComponent: WrappedStyledComponent, forwardedRef: ref }));
  };
  forwardRef2.displayName = displayName;
  WrappedStyledComponent = import_react4.default.forwardRef(forwardRef2);
...
var ImageLoader = function(_React$Component) {
  ...
  createClass2(ImageLoader2, [{
    ...
    value: function render() {
      ...
      return lazyLoad ? import_react5.default.createElement(import_react_visibility_sensor.default, {
...
var BackgroundImage = function BackgroundImage2(_ref) {
  ...
  return import_react5.default.createElement(ImageLoader, { src, transitionTime, lazyLoad }, function(_ref2) {
    ...
    if (useChild) {
      ...
      childElement = import_react5.default.cloneElement(children, { style });
    } else {
      ...
      hasLoaded ? style = _extends2({}, style, backgroundImageStyle) : style;
      childElement = import_react5.default.createElement(element, _extends2({}, props, { style }), children);
    }
    return import_react5.default.createElement(Wrapper$2, {
      width,
      height,
      isResponsive,
      className: wrapperClassName
    }, childElement, shouldShowLoader && !disableLoader && import_react5.default.createElement(import_react5.Fragment, null, renderLoader ? renderLoader({ hasLoaded, hasFailed }) : import_react5.default.createElement(Loader, {
      isOnTop: true,
      hasLoaded,
      transitionTime
    })));
...
var Image2 = function Image3(_ref) {
  ...
  return isResponsive ? import_react5.default.createElement(BackgroundImage, _extends2({
    src,
    width,
    height,
    transitionTime,
    ...
    lazyLoad,
    isResponsive: true
  }, props)) : import_react5.default.createElement(ImageLoader, { src, transitionTime, lazyLoad }, function(_ref2) {
    var hasLoaded = _ref2.hasLoaded, shouldShowLoader = _ref2.shouldShowLoader, hasFailed = _ref2.hasFailed, src2 = _ref2.src;
    return import_react5.default.createElement(Wrapper$1, { width, height, className: wrapperClassName }, hasLoaded && import_react5.default.createElement(Img, _extends2({ src: src2, transitionTime }, props)), shouldShowLoader && !disableLoader && import_react5.default.createElement(import_react5.Fragment, null, renderLoader ? renderLoader({ hasLoaded, hasFailed }) : import_react5.default.createElement(Loader, null)));
  });
};
Image2.propTypes = {
  src: import_prop_types5.default.string.isRequired,
...
var BaseImage = ({
  ...
  const ImageComponent = (0, import_react6.useMemo)(() => {
    return backGroundMode ? /* @__PURE__ */ import_react6.default.createElement(BackgroundImage, {
      className: `${className || ""}`,
      style: {
      ...
      title,
      disableLoader
    }) : /* @__PURE__ */ import_react6.default.createElement(Image2, {
      className: `${className || ""}`,
      style,
      src,
      width,
 ...
 */
//# sourceMappingURL=/build/routes/index-MKR7HJBY.js.map
