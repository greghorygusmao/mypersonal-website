...
var useScroll = () => {
  const { scroll } = (0, import_react3.useContext)(SmoothScrollContext);
  const { ref, height } = useDebouncedResizeObserver(500);
  const [render, setrender] = (0, import_react3.useState)(0);
  const goTo = (ind) => {
    if (ref?.current) {
...
//# sourceMappingURL=/build/routes/cms-YYT4Q55Z.js.map
