...
import {
  ...
  Title,
  links
} from "/build/_shared/chunk-NAKA57OX.js";
import {
  require_prop_types,
  require_react_is
...
var BaseText = ({
  ...
  return /* @__PURE__ */ import_react4.default.createElement(CustomTag, {
    className: `${className || ""}`,
    style,
    title: aria,
    ...hrefProp,
...
BaseText.propTypes = {
  ...
  aria: import_prop_types4.default.string,
...
var ColumnCards = ({ data, style }) => {
  const dataFiltered = (0, import_react7.useMemo)(() => {
    let finish = [];
    let proccess = [];
    data?.data?.forEach((e) => {
      if (e.dueComplete) {
...
function Index() {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    return /* @__PURE__ */ React.createElement(ColumnCards, {
      data: e,
      key: e.name,
      style: { marginRight: "50px", marginBottom: "120px", alignSelf: "baseline" }
    });
  }))));
}
export {
...
***************************************************************************** */
//# sourceMappingURL=/build/routes/index-EXFELFQT.js.map
