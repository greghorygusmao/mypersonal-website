...
var ThemeProvider = function(_Component) {
  ...
  ThemeProvider2.prototype.render = function render() {
    if (!this.props.children)
      return null;
    return import_react.default.createElement(ThemeContext.Consumer, null, this.renderInner);
  };
  ThemeProvider2.prototype.renderInner = function renderInner(outerTheme) {
    var context = this.getContext(this.props.theme, outerTheme);
    return import_react.default.createElement(ThemeContext.Provider, { value: context }, this.props.children);
  };
...
var ServerStyleSheet = function() {
  ...
  ServerStyleSheet2.prototype.collectStyles = function collectStyles(children) {
    ...
    return import_react.default.createElement(StyleSheetManager, { sheet: this.instance }, children);
  };
...
var StyleSheetContext = (0, import_react.createContext)();
...
var StyleSheetManager = function(_Component) {
  ...
  StyleSheetManager2.prototype.render = function render() {
    ...
    return import_react.default.createElement(StyleSheetContext.Provider, { value: this.getContext(sheet, target) }, true ? import_react.default.Children.only(children) : children);
  };
...
` + ("For example, { " + key + ": () => InnerComponent } instead of { " + key + ": InnerComponent }"));
  ...
  StyledComponent2.prototype.render = function render() {
    return import_react.default.createElement(StyleSheetConsumer, null, this.renderOuter);
  };
  StyledComponent2.prototype.renderOuter = function renderOuter() {
    ...
    return import_react.default.createElement(ThemeConsumer, null, this.renderInner);
  };
...
function createStyledComponent(target, options, rules) {
  ...
  WrappedStyledComponent = import_react.default.forwardRef(forwardRef2);
...
var Loader = function Loader2(_ref) {
  ...
  return import_react2.default.createElement(Wrapper, {
    isOnTop,
    hasLoaded,
    transitionTime
  });
...
Loader.propTypes = {
  isOnTop: import_prop_types2.default.bool,
  hasLoaded: import_prop_types2.default.bool,
  transitionTime: import_prop_types2.default.string
};
Loader.defaultProps = {
...
var ImageLoader = function(_React$Component) {
  ...
  createClass2(ImageLoader2, [{
    ...
    value: function render() {
      ...
      return lazyLoad ? import_react2.default.createElement(import_react_visibility_sensor.default, {
...
ImageLoader.propTypes = {
  ...
  transitionTime: import_prop_types2.default.string,
  lazyLoad: import_prop_types2.default.bool,
  children: import_prop_types2.default.oneOfType([import_prop_types2.default.arrayOf(import_prop_types2.default.node), import_prop_types2.default.node, import_prop_types2.default.func])
};
...
var BackgroundImage = function BackgroundImage2(_ref) {
  ...
  return import_react2.default.createElement(ImageLoader, { src, transitionTime, lazyLoad }, function(_ref2) {
    ...
    if (useChild) {
      ...
      childElement = import_react2.default.cloneElement(children, { style });
    } else {
      ...
      hasLoaded ? style = _extends2({}, style, backgroundImageStyle) : style;
      childElement = import_react2.default.createElement(element, _extends2({}, props, { style }), children);
    }
    return import_react2.default.createElement(Wrapper$2, {
      width,
      height,
      isResponsive,
      className: wrapperClassName
    }, childElement, shouldShowLoader && !disableLoader && import_react2.default.createElement(import_react2.Fragment, null, renderLoader ? renderLoader({ hasLoaded, hasFailed }) : import_react2.default.createElement(Loader, {
      isOnTop: true,
      hasLoaded,
      transitionTime
    })));
...
BackgroundImage.propTypes = {
  ...
  transitionTime: import_prop_types2.default.string,
  renderLoader: import_prop_types2.default.func,
  disableLoader: import_prop_types2.default.bool,
  useChild: import_prop_types2.default.bool,
  children: import_prop_types2.default.oneOfType([import_prop_types2.default.arrayOf(import_prop_types2.default.node), import_prop_types2.default.node]),
  element: import_prop_types2.default.string,
  style: import_prop_types2.default.object,
  wrapperClassName: import_prop_types2.default.string,
  lazyLoad: import_prop_types2.default.bool,
  isResponsive: import_prop_types2.default.bool
};
...
var Image2 = function Image3(_ref) {
  ...
  return isResponsive ? import_react2.default.createElement(BackgroundImage, _extends2({
    src,
    width,
    height,
    transitionTime,
    ...
    lazyLoad,
    isResponsive: true
  }, props)) : import_react2.default.createElement(ImageLoader, { src, transitionTime, lazyLoad }, function(_ref2) {
    var hasLoaded = _ref2.hasLoaded, shouldShowLoader = _ref2.shouldShowLoader, hasFailed = _ref2.hasFailed, src2 = _ref2.src;
    return import_react2.default.createElement(Wrapper$1, { width, height, className: wrapperClassName }, hasLoaded && import_react2.default.createElement(Img, _extends2({ src: src2, transitionTime }, props)), shouldShowLoader && !disableLoader && import_react2.default.createElement(import_react2.Fragment, null, renderLoader ? renderLoader({ hasLoaded, hasFailed }) : import_react2.default.createElement(Loader, null)));
  });
};
Image2.propTypes = {
  src: import_prop_types2.default.string.isRequired,
...
var BaseImage = ({
  ...
  const ImageComponent = (0, import_react3.useMemo)(() => {
    return backGroundMode ? /* @__PURE__ */ import_react3.default.createElement(BackgroundImage, {
      className: `${className || ""}`,
      style: {
      ...
      title,
      disableLoader
    }) : /* @__PURE__ */ import_react3.default.createElement(Image2, {
      className: `${className || ""}`,
      style,
      src,
      width,
...
var Box2 = (0, import_react4.forwardRef)((props, ref) => {
  const {
    children,
    style,
    flexDirection,
...
Box2.propTypes = {
  ...
  flexDirection: import_prop_types4.default.string,
  justifyContent: import_prop_types4.default.string,
  alignItems: import_prop_types4.default.string,
...
var styles_default3 = "/build/_assets/styles-55DNWN2R.css";
...
function Index() {
  ...
  }, /* @__PURE__ */ React.createElement(LeftNavbar, null), /* @__PURE__ */ React.createElement(Box, {
    flexDirection: "column",
    style: {
      padding: "30px"
    }
 ...
 */
//# sourceMappingURL=/build/routes/index-PSH5J6BS.js.map
